---
title: 10.6.3 Release
alias: rl/releases/rl10_10.6.3_release.html
description: Version-specific information for the 10.6.3 Release of RightLink.
---

10.6.3 is a point release for the last major GA release. This release includes:

###Fixes
1. Fix rightlink.init to work with '/bin/sh' and handle older versions of 'start-stop-daemon'
1. Golang 1.8 -> 1.14
  - [Release History](https://golang.org/doc/devel/release.html#go1.14)
1. Websocket -> 1.4.2
  - Improved Buffer Code
  - Improved Handshake Timeout
  - Buffer Pooling
1. Add Support for `local` timestamps in retry
1. Removed Unnecessary Log Lines to slim down communication

## Quick Reference

| Item       | Description |
| ---------- | ----------- |
| RightLink10 Change Log | [https://rightlink.rightscale.com/rll/10.6.3/CHANGES.md](https://rightlink.rightscale.com/rll/10.6.3/CHANGES.md) |
...
| Linux Install-on-image | Installation package: [https://rightlink.rightscale.com/rll/10.6.3/rightlink.tgz](https://rightlink.rightscale.com/rll/10.6.3/rightlink.tgz) |
| Linux Install-at-boot | To run: Import Linux Base ServerTemplate, create server from ST, pick desired MCI, launch |
| Linux Enable-running | Script: [https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.sh](https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.sh)<br>To run: Import Linux Base ServerTemplate, launch raw instance, copy key from<br><b>Settings > Account Settings > API credentials</b>, SSH into raw instance<br>Run command:<br><code>curl -s https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.sh &#124; bash -s -- -k &quot;&lt;your-key&gt;&quot; -d &quot;&lt;deployment-name&gt;&quot; -n &quot;&lt;your-server-name&gt;&quot; -t &quot;RightLink 10.6.3 Linux Base&quot; -a &quot;us-3.rightscale.com&quot; -c &quot;&lt;cloud_type&gt;&quot;</code> |
...
| Windows Install-on-image | Installation package: [https://rightlink.rightscale.com/rll/10.6.3/rightlink.zip](https://rightlink.rightscale.com/rll/10.6.3/rightlink.zip) |
| Windows Enable-running | Script: [https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.ps1](https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.ps1)<br>To run: Import Windows Base ServerTemplate, launch raw instance, copy key from <br><b>Settings > Account Settings > API credentials</b>, Remote Desktop into raw instance<br>Run command:<br><code>$wc = New-Object System.Net.WebClient</code><br><code>$wc.DownloadFile(&quot;https://rightlink.rightscale.com/rll/10.6.3/rightlink.enable.ps1&quot;, &quot;rightlink.enable.ps1&quot;);</code><br><code>Powershell -ExecutionPolicy Unrestricted -File rightlink.enable.ps1 -k &quot;&lt;your-key&gt;&quot; -d &quot;&lt;deployment-name&gt;&quot; -n &quot;&lt;your-server-name&gt;&quot; -t &quot;RightLink 10.6.3 Windows Base&quot; -a &quot;us-3.rightscale.com&quot; -c &quot;&lt;cloud_type&gt;&quot;</code>
