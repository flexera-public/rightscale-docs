---
title: 10.5.3 Release
alias: rl/releases/rl10_10.5.3_release.html
description: Version-specific information for the 10.5.3 Release of RightLink.
---

10.5.3 is a point release for the last major GA release ([10.5.0](rl10_10.5.0_release.html)).  This release includes:

###Features
1. Added support for RHEL 6 and RHEL 7
2. Added RightScripts rll/redhat-subscription-register.sh and rll/redhat-subscription-unregister.sh to register and unregister RHEL instances with RedHat Subscription Management Services
3. Update version of RightScale Network Agent installed for RCA-V instances. Installation of RightScale Network Agent scripts for RCA-V on Linux servers will raise an error if NetworkManager is installed. See [Advanced Networking for vSphere](/rl10/reference/rl10_rcav.html) for more details.

###Fixes
1. Fix systemd SIGPIPE issue (https://bugs.freedesktop.org/show_bug.cgi?id=84923) by restarting rightlink once process is idle and no longer executing scripts.

## Quick Reference

| Item       | Description |
| ---------- | ----------- |
| RightLink10 Change Log | [https://rightlink.rightscale.com/rll/10.5.3/CHANGES.md](https://rightlink.rightscale.com/rll/10.5.3/CHANGES.md) |
| RightScripts Change Log | [https://github.com/rightscale/rightlink_scripts/blob/10.5.3/CHANGES.md](https://github.com/rightscale/rightlink_scripts/blob/10.5.3/CHANGES.md) |
| Github repo for Base ServerTemplates | [https://github.com/rightscale/rightlink_scripts/tree/10.5.3](https://github.com/rightscale/rightlink_scripts/tree/10.5.3) |
| GitHub repo for optional example RightScripts | [https://github.com/rightscale/rightlink_scripts/tree/10.5.3/rll-examples](https://github.com/rightscale/rightlink_scripts/tree/10.5.3/rll-examples) | 
...
| Linux Install-on-image | Installation package: [https://rightlink.rightscale.com/rll/10.5.3/rightlink.tgz](https://rightlink.rightscale.com/rll/10.5.3/rightlink.tgz) |
| Linux Install-at-boot | To run: Import Linux Base ServerTemplate, create server from ST, pick desired MCI, launch |
| Linux Enable-running | Script: [https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.sh](https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.sh)<br>To run: Import Linux Base ServerTemplate, launch raw instance, copy key from<br><b>Settings > Account Settings > API credentials</b>, SSH into raw instance<br>Run command:<br><code>curl -s https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.sh &#124; bash -s -- -k &quot;&lt;your-key&gt;&quot; -d &quot;&lt;deployment-name&gt;&quot; -n &quot;&lt;your-server-name&gt;&quot; -t &quot;RightLink 10.5.3 Linux Base&quot; -a &quot;us-3.rightscale.com&quot; -c &quot;&lt;cloud_type&gt;&quot;</code> |
...
| Windows Install-on-image | Installation package: [https://rightlink.rightscale.com/rll/10.5.3/rightlink.zip](https://rightlink.rightscale.com/rll/10.5.3/rightlink.zip) |
| Windows Enable-running | Script: [https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.ps1](https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.ps1)<br>To run: Import Windows Base ServerTemplate, launch raw instance, copy key from <br><b>Settings > Account Settings > API credentials</b>, Remote Desktop into raw instance<br>Run command:<br><code>$wc = New-Object System.Net.WebClient</code><br><code>$wc.DownloadFile(&quot;https://rightlink.rightscale.com/rll/10.5.3/rightlink.enable.ps1&quot;, &quot;rightlink.enable.ps1&quot;);</code><br><code>Powershell -ExecutionPolicy Unrestricted -File rightlink.enable.ps1 -k &quot;&lt;your-key&gt;&quot; -d &quot;&lt;deployment-name&gt;&quot; -n &quot;&lt;your-server-name&gt;&quot; -t &quot;RightLink 10.5.3 Windows Base&quot; -a &quot;us-3.rightscale.com&quot; -c &quot;&lt;cloud_type&gt;&quot;</code>
