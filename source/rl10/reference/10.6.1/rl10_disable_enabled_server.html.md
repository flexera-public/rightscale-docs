...
1. The command line to run on the instance looks something like this, for version 10.6.1

    ~~~ bash
    curl -s https://rightlink.rightscale.com/rll/10.6.1/rightlink.disable.sh | sudo bash -s -- -k e22f8d37...456
    ~~~
    ...
    $wc.DownloadFile("https://rightlink.rightscale.com/rll/10.6.1/rightlink.disable.ps1", "$pwd\rightlink.disable.ps1")
