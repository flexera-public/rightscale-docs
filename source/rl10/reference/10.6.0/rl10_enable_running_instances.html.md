...
1. The command line to install RightLink and have it run on the instance looks something like this, for version 10.6.0:
  ~~~ bash
  curl -s https://rightlink.rightscale.com/rll/10.6.0/rightlink.enable.sh | sudo bash -s -- -k "e22f8d37...456" -t "RightLink 10.5.2 Linux Base" -n "Test Server" -d "Staging Deployment" -c "amazon"
  ~~~
