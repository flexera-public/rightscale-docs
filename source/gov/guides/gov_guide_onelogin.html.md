...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="extract-user">
    <user>
      <xsl:for-each select="saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='email']/saml:AttributeValue">
        <email><xsl:value-of select="."/></email>
      </xsl:for-each>
      <xsl:for-each select="saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='surname']/saml:AttributeValue">
        <surname><xsl:value-of select="."/></surname>
      </xsl:for-each>
      <xsl:for-each select="saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='givenname']/saml:AttributeValue">
