...
description: This guide explains how to configure an existing vSphere environment so that its underlying resources can be managed through the RightScale Cloud Management Platform.
---
...
3. [Register a vSphere Cloud with RightScale](rcav_register_vsphere_cloud.html)

## See Also

* [RCA-V Image Requirements](rcav_image_requirements.html)
